...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "appDescription": MessageLookupByLibrary.simpleMessage(
            "beFit, gizliliğinize saygı duyan ücretsiz ve açık kaynaklı bir kalori ve besin takip programıdır."),
        "appLicenseLabel":
        ...
        "disclaimerText": MessageLookupByLibrary.simpleMessage(
            "beFit tıbbi bir uygulama değildir. Sağlanan tüm veriler doğrulanmamıştır ve dikkatli kullanılmalıdır. Lütfen sağlıklı bir yaşam tarzı sürdürün ve herhangi bir sorun yaşarsanız bir uzmana danışın. Hastalık, hamilelik veya emzirme döneminde kullanılması önerilmez.\n\n\nUygulama halen geliştirilme aşamasındadır. Hatalar veya çökmeler meydana gelebilir."),
        "editMealLabel":
