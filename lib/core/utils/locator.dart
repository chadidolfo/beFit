...
import 'package:beFit/core/data/data_source/config_data_source.dart';
import 'package:beFit/core/data/data_source/intake_data_source.dart';
import 'package:beFit/core/data/data_source/physical_activity_data_source.dart';
import 'package:beFit/core/data/data_source/tracked_day_data_source.dart';
import 'package:beFit/core/data/data_source/user_activity_data_source.dart';
...
import 'package:beFit/core/data/repository/tracked_day_repository.dart';
...
import 'package:beFit/core/domain/usecase/add_config_usecase.dart';
import 'package:beFit/core/domain/usecase/add_intake_usecase.dart';
...
import 'package:beFit/core/domain/usecase/add_user_usecase.dart';
import 'package:beFit/core/domain/usecase/delete_intake_usecase.dart';
import 'package:beFit/core/domain/usecase/delete_user_activity_usecase.dart';
import 'package:beFit/core/domain/usecase/get_config_usecase.dart';
import 'package:beFit/core/domain/usecase/get_intake_usecase.dart';
import 'package:beFit/core/domain/usecase/get_physical_activity_usecase.dart';
import 'package:beFit/core/domain/usecase/get_tracked_day_usecase.dart';
import 'package:beFit/core/domain/usecase/get_user_activity_usecase.dart';
import 'package:beFit/core/domain/usecase/get_user_usecase.dart';
import 'package:beFit/core/domain/usecase/update_intake_usecase.dart';
import 'package:beFit/core/utils/env.dart';
import 'package:beFit/core/utils/hive_db_provider.dart';
import 'package:beFit/core/utils/ont_image_cache_manager.dart';
import 'package:beFit/core/utils/secure_app_storage_provider.dart';
import 'package:beFit/features/activity_detail/presentation/bloc/activity_detail_bloc.dart';
import 'package:beFit/features/add_activity/presentation/bloc/activities_bloc.dart';
import 'package:beFit/features/add_activity/presentation/bloc/recent_activities_bloc.dart';
import 'package:beFit/features/add_meal/data/data_sources/fdc_data_source.dart';
import 'package:beFit/features/add_meal/data/data_sources/off_data_source.dart';
import 'package:beFit/features/add_meal/data/data_sources/sp_fdc_data_source.dart';
import 'package:beFit/features/add_meal/data/repository/products_repository.dart';
import 'package:beFit/features/add_meal/domain/usecase/search_products_usecase.dart';
import 'package:beFit/features/add_meal/presentation/bloc/food_bloc.dart';
import 'package:beFit/features/add_meal/presentation/bloc/products_bloc.dart';
import 'package:beFit/features/add_meal/presentation/bloc/recent_meal_bloc.dart';
import 'package:beFit/features/diary/presentation/bloc/calendar_day_bloc.dart';
import 'package:beFit/features/diary/presentation/bloc/diary_bloc.dart';
import 'package:beFit/features/edit_meal/presentation/bloc/edit_meal_bloc.dart';
import 'package:beFit/features/home/presentation/bloc/home_bloc.dart';
import 'package:beFit/features/meal_detail/presentation/bloc/meal_detail_bloc.dart';
import 'package:beFit/features/onboarding/presentation/bloc/onboarding_bloc.dart';
import 'package:beFit/features/profile/presentation/bloc/profile_bloc.dart';
import 'package:beFit/features/scanner/domain/usecase/search_product_by_barcode_usecase.dart';
import 'package:beFit/features/scanner/presentation/scanner_bloc.dart';
import 'package:beFit/features/settings/presentation/bloc/settings_bloc.dart';
